	...
	<div class="container">
		<div class="card mt-5">
					...
					<tbody >
						<tr >							
							<?php
								...
								$show_table = "SELECT * FROM worker_data WHERE name LIKE '%$search%' OR email LIKE '%$search%' OR phone LIKE '%$search%' ";
			...
			<div class="card-footer">
				<a class="btn btn-success btn-sm shadow" href="worker-profile.php">Profile</a>
				<a class="btn btn-info btn-sm shadow" href="worker-table.php">Table</a>
			</div>
		</div>
	</div>
